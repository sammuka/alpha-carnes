...
| 2 | Shell + DS fiel ao protótipo (layout, menu 9 grupos, tokens, componentes compartilhados) | 1 | aguardando_portao1 | [`2026-07-25-onda2-shell-ds.md`](../superpowers/plans/2026-07-25-onda2-shell-ds.md) | — | — | Plano tático escrito na branch `feature/onda2-plano-shell-ds` (sha256 `9fcd8c4c…`), 9 Tasks com 28 invariantes no mapa DoD→teste; aguarda veredito do Portão 1. Implementação irá na branch `feature/onda2-shell-ds` |
