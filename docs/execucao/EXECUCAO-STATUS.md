...
| 3 | Cadastros & Regras completos + Admin | 2 | implementando | [`2026-07-25-onda3-cadastros-admin.md`](../superpowers/plans/2026-07-25-onda3-cadastros-admin.md) | [#21](https://github.com/sammuka/alpha-carnes/pull/21) | — | PR [#21](https://github.com/sammuka/alpha-carnes/pull/21) aberto (@ `55dc785`) com gaps: Tasks 17–24/27 incompletas (UI paradas, patches admin, evidências, gate local parcial). Tasks 7–16/25 ok. Pin `9c943064…`. Worker retomado para fechar o plano antes do Portão 2. Worktree `.worktrees/onda3-impl` |
