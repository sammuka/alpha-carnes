...
| 2 | Shell + DS fiel ao protótipo (layout, menu 9 grupos, tokens, componentes compartilhados) | 1 | implementando | [`2026-07-25-onda2-shell-ds.md`](../superpowers/plans/2026-07-25-onda2-shell-ds.md) | — | — | Portão 1 **aprovado** (veredito `061a2d5`); plano mergeado em `develop` via PR [#15](https://github.com/sammuka/alpha-carnes/pull/15) squash `15ebc145bf45dea7b874f78864c7403ff95140bc`; sha256 pin `9a9f8b36…`; CI verde no head do veredito (run `30153517846`). Implementação na branch `feature/onda2-shell-ds` (worktree `.worktrees/onda2-impl`). 9 Tasks, 31 decisões, mapa DoD→teste; dívidas NF Onda 1 → Onda 6; 26 perdas RBAC → Onda 3 |
