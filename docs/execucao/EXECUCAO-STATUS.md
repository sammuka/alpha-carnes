...
| 3 | Cadastros & Regras completos + Admin | 2 | aguardando_portao1 | [`2026-07-25-onda3-cadastros-admin.md`](../superpowers/plans/2026-07-25-onda3-cadastros-admin.md) | — | — | Dependência Onda 2 `mergeada`. Plano tático na branch `feature/onda3-plano-cadastros-admin` (worktree `.worktrees/onda3-plan`), sha256 `2aa62549c3a85565d2bcd0458411043a7f9b5c4718c291583868197cf09390b3` — 27 tasks, 42 decisões, 77 invariantes DoD. Dívidas da Onda 2 absorvidas no mapa DoD→teste: **26 perdas** (decisão 25) em DoD-05/DoD-07, conciliação catálogo×matriz (decisão 31) em DoD-06/DoD-08/DoD-12, linha 41 da matriz (decisão 27) em DoD-33 a DoD-35 e DoD-65 a DoD-69. P13 fechada por AD-04 (`ESTOQUE_*`) |
