...
| 3 | Cadastros & Regras completos + Admin | 2 | implementando | [`2026-07-25-onda3-cadastros-admin.md`](../superpowers/plans/2026-07-25-onda3-cadastros-admin.md) | [#21](https://github.com/sammuka/alpha-carnes/pull/21) | — | Portão 1 re-aprovado no gate Playwright Task 27 (veredito `545c854`). Plano via PR [#22](https://github.com/sammuka/alpha-carnes/pull/22). sha256 pin `97a53ecde7b2d694a610a9f1920a68fa0077cc1d377ac28e99638915f11f252d`. Worker retoma Task 27 (evidências + gate scoped). Tasks 17–26 já no PR #21 |
