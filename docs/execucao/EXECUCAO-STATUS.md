...
| 3 | Cadastros & Regras completos + Admin | 2 | implementando | [`2026-07-25-onda3-cadastros-admin.md`](../superpowers/plans/2026-07-25-onda3-cadastros-admin.md) | — | — | Portão 1 re-aprovado na emenda CHECK PG18 (veredito `da0597a`). Plano emendado via PR [#19](https://github.com/sammuka/alpha-carnes/pull/19) squash `870f158`. sha256 pin `f3eac263ded786da1640825a5a554c17650103966854d38d4f947d026d33a25f` — 27 tasks, 46 decisões, 86 invariantes DoD. Retomada do Worker a partir da Task 1 (WIP anterior descartado). Worktree `.worktrees/onda3-impl`, branch `feature/onda3-cadastros-admin` |
