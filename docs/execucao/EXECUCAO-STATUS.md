...
| 1 | Correção estrutural: Operação (D2), overbooking v1.1 (D1), Pedido ao Fornecedor + conferência tripla (D3), terminologia (D5) | 0 | implementando | [`2026-07-22-onda1-correcao-estrutural.md`](../superpowers/plans/2026-07-22-onda1-correcao-estrutural.md) | — | — | Plano aprovado no Portão 1 (sha256 `2d52f9df…`); integrado em `develop` pelo PR [#12](https://github.com/sammuka/alpha-carnes/pull/12) squash `04e3d6c29ecea807b8d2a9db931cd12ee83a8661`. Worktree `.worktrees/onda1-impl`, branch `feature/onda1-correcao-estrutural`. D9 concluída antes pelo PR [#11](https://github.com/sammuka/alpha-carnes/pull/11) |
