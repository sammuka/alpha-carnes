...
| 1 | Correção estrutural: Operação (D2), overbooking v1.1 (D1), Pedido ao Fornecedor + conferência tripla (D3), terminologia (D5) | 0 | aguardando_portao1 | [`2026-07-22-onda1-correcao-estrutural.md`](../superpowers/plans/2026-07-22-onda1-correcao-estrutural.md) | — | — | Plano tático entregue junto do mestre. D9 (instruções canônicas `AGENTS.md` + `CLAUDE.md` compat.) reescopada para fora desta onda: **concluída antes da Onda 1 pelo PR [#11](https://github.com/sammuka/alpha-carnes/pull/11)**, squash `8b2958ef992e1243015cd7f0507310dbac9706e0` — sem nova task |
