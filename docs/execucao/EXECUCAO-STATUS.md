...
| 2 | Shell + DS fiel ao protótipo (layout, menu 9 grupos, tokens, componentes compartilhados) | 1 | aguardando_portao2 | [`2026-07-25-onda2-shell-ds.md`](../superpowers/plans/2026-07-25-onda2-shell-ds.md) | [#16](https://github.com/sammuka/alpha-carnes/pull/16) | — | Portão 1 aprovado (`061a2d5`); plano em `develop` via PR [#15](https://github.com/sammuka/alpha-carnes/pull/15) (`15ebc14`); sha256 `9a9f8b36…`. PR de implementação head `e160321`, CI verde run `30155114508` (lease PUBLIC→PRIVATE). Gate local Worker: frontend 152 testes, backend 820, build/audit ok. Aguarda Portão 2 |
