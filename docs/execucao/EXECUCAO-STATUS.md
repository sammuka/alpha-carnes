...
| 3 | Cadastros & Regras completos + Admin | 2 | implementando | [`2026-07-25-onda3-cadastros-admin.md`](../superpowers/plans/2026-07-25-onda3-cadastros-admin.md) | — | — | Portão 1 re-aprovado na emenda Task 7 (veredito `3ee82e7`, recheck4). Plano via PR [#20](https://github.com/sammuka/alpha-carnes/pull/20) squash em develop. sha256 pin `9c94306463071fab96c84394bbd8e9eec7c7f6e728acd54345c1ccc4fea046f1` — join/coalesce + rótulos + harness 9.7 + criarServiceCom 10.3. Retomada do Worker a partir da Task 7 (Tasks 1–6 já em `051c1a8`). Worktree `.worktrees/onda3-impl`, branch `feature/onda3-cadastros-admin` |
