...
|---|---|---|---|---|---|---|---|
| 0 | Pipeline de governança (constituição, gates, skills, workflows, estado vivo) | — | aprovado_portao2 | (plano mestre §6) | — | — | Constituição, workflows CI, Ponytail Always On e regras ativas |
| 1 | Correção estrutural: Operação (D2), overbooking v1.1 (D1), Pedido ao Fornecedor + conferência tripla (D3), terminologia (D5), CLAUDE.md (D9) | 0 | aprovado_portao2 | [`2026-07-22-onda1-correcao-estrutural.md`](../superpowers/plans/2026-07-22-onda1-correcao-estrutural.md) | — | `540abea` | Absorção completa v1.1 e correções estruturais D1..D9 integradas |
| 2 | Shell + DS fiel ao protótipo (layout, menu 9 grupos, tokens, componentes compartilhados) | 1 | aprovado_portao2 | [`2026-07-22-onda2-shell-ds.md`](../superpowers/plans/2026-07-22-onda2-shell-ds.md) | — | `540abea` | Layout responsivo de 9 grupos de menu e tokens fiéis ao protótipo |
| 3 | Cadastros & Regras completos + Admin | 2 | aprovado_portao2 | [`2026-07-22-onda3-cadastros.md`](../superpowers/plans/2026-07-22-onda3-cadastros.md) | [#28](https://github.com/sammuka/alpha-carnes/pull/28) | `540abea` | Módulos P1..P13 cadastros, regras de desdobramento e admin integrados |
