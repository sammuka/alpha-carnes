...
| 4 | Comercial (Clientes, Pedidos, Preços, Disponibilidade-mapa, Espelho) | 3 | planejando | just-in-time | — | — | Branch `feature/onda4-plano-comercial`; plano tático em elaboração (Portão 1 pendente). AD-06 vigente. |
